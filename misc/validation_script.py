...
PREDICTIONS_PATH_6_1 = 'data/processed/lasigeBioTM_subtask6_1_NER_Mistral-7B-Instruct-v0.3_fixed.json'
PREDICTIONS_PATH_6_2 = 'path/to/your/binary_tag_RE/predictions/in/json/format'
# PREDICTIONS_PATH_6_3 = 'data/processed/lasigeBioTM_Mistral-7B-Instruct-v0.3-baseline-labels-it-outputs_CLEANED.json'
# PREDICTIONS_PATH_6_4 = 'data/processed/lasigeBioTM_Mistral-7B-Instruct-v0.3-baseline-labels-it-outputs_CLEANED.json'

# PREDICTIONS_PATH_6_3 = 'data/processed//Mistral-7B-Instruct-v0.3-raw-baseline-it-outputs_CLEANED.json'
# PREDICTIONS_PATH_6_4 = 'data/processed//Mistral-7B-Instruct-v0.3-raw-baseline-it-outputs_CLEANED.json'
#path= "data/processed/Mistral-7B-Instruct-v0.3-spacy-semantics-it-outputs_CLEANED.json"

path="data/processed/Mistral-7B-Instruct-v0.3-constparsing-it-outputs_CLEANED.json"

PREDICTIONS_PATH_6_3 = path
PREDICTIONS_PATH_6_4 = path
