...
def main():
    ...
    output_path=f"data/intermediate/{model_name.split("/")[-1]}-NER-it-outputs-baseline.json"
    output_logs=f"data/intermediate/{model_name.split("/")[-1]}-NER-it-outputs-baseline.LOGS"
